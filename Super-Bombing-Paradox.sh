...
banner() {
    ...
    if ! [ -x "$(command -v figlet)" ]; then
        echo 'Introducing Super-Bombing-Paradox'
    else
                 figlet Super-Bombing-Paradox
    fi
    if ! [ -x "$(command -v toilet)" ]; then
        echo -e "\e[4;34m This Bomber Was Created By \e[1;32mPrometheus Paradox \e[0m"
    else
        echo -e "\e[1;34mCreated By \e[1;34m"
        figlet Prometheus Paradox
    printf "\033[1;93m[\033[1;77m::\033[1;93m]	    \033[1;92m   Code by : \033[1;97m   SANJIB    \033[1;93m[\033[1;77m::\033[1;93m]"
	printf "\n\033[1;93m[\033[1;77m::\033[1;93m]	\033[1;92mmodify code by : \033[1;97m SANJIB \033[1;93m[\033[1;77m::\033[1;93m]\n"
    echo " "
    echo " "
    echo -e            *Requirements:*
...
if [ -f .update ];then
    ...
    echo .
    install_deps
    echo This Script Was Made By Prometheus Paradox  > .update
...
do
    ...
    echo " "
    echo -e "'\033[1;31m                           ⫸ Coded by\033[1;32m Prometheus Paradox\033[1;31m ⫷\033[0m"
    echo -e "'\033[1;31m                         ⫸\033[1;33m Prometheus Paradox\033[1;31m ⫷\033[0m"
    echo 
...
echo " "
   ...
   if [ $ch -eq 1 ];then
        ...
        cd $HOME
        cd Super-Bombing-paradox
        bash Super-Bomming-Paradox.sh
    elif [ $ch -eq 5 ];then
        echo -e "\e[1;34m Downloading Latest Files..."
        cd $HOME
        rm -rf Super-Bombing-Paradox
        
        cd Super-Bombing-Paradox
        bash Super-Bombing-Paradox.sh
