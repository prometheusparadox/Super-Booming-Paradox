...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("Super-Bombing is up-to-date")
        mesgdcrt.GeneralMessage("Starting Super-Bombing")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("Super-Bombing was created by Prometheus Paradox")
    mesgdcrt.SuccessMessage("Super-Bombing was modified by Prometheus Paradox")
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 100000000000, "call": 500000000, "mail": 200000000}
        cc, target = "", ""
        if mode in ["sms", "call"]:
...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("Super-Bombing Paradox will work only in Python v3")
    sys.exit()
...
__CONTRIBUTORS__ = ['Prometheus Paradox']
...
description = """Super-Bombing Paradox - Your Friendly Spammer Application

 Super-Bombing Paradox can be used for many purposes which incudes -
\t Exposing the vulnerable APIs over Internet
\t Friendly Spamming
\t Testing Your Spam Detector and more ....

Super-Bombing is not intented for malicious uses.
"""
